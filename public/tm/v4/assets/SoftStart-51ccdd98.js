import{r as s,j as e,D as o,a as t,B as n}from"./index-17ca14c8.js";import{u as c}from"./useGame-545831b3.js";function m(){const[a,r]=s.useState(null);return s.useEffect(()=>{const i=setTimeout(()=>{r("A város jelei nem mindig ott vannak, ahol keresed.")},3e5),l=setTimeout(()=>{r("Ha elindulnál, a Főtér környéke jó kezdet.")},10*60*1e3);return()=>{clearTimeout(i),clearTimeout(l)}},[]),a?e("div",{className:`\r
