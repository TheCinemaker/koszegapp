    ...
    try {
      ...
      `)
        ...
        try {
            ...
            const stripUrl = `${SITE_URL}/images/events/wallet.png`; // Fetch from URL!
            const stripBuffer = await getBuffer(stripUrl);

            if (stripBuffer) {
                const stripImage = await Jimp.read(stripBuffer);
                ...
                console.warn('Strip image fetch failed:', stripUrl);
            }
