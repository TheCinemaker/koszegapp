                ...
                <div className="scroll-mask flex-1 overflow-y-auto relative z-10 px-4 sm:px-8 md:px-16 pt-12 pb-12">
                  <div className="font-zeyada text-amber-900 text-2xl sm:text-3xl leading-relaxed text-center space-y-10 font-bold">
                    <div className="flex justify-between items-center flex-wrap gap-4">
                      ...
                      <button onClick={() => setIsFlipped(true)} className="flex items-center gap-2 bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition font-sans font-semibold">
                        <FaMap /> Térképnézet
                      </button>
                    </div>
                    {allGems.length > 0 ? (
            ...
            <div className="flip-card-back">
              <div className="w-full h-full flex flex-col rounded-2xl shadow-2xl border-2 border-amber-700/40 bg-amber-50/90 dark:bg-gray-800/90 backdrop-blur-sm p-4 md:p-6">
                <div className="flex justify-between items-center mb-4 flex-wrap gap-2">
                  ...
                  <button onClick={() => setIsFlipped(false)} className="flex items-center gap-2 bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition font-sans font-semibold">
