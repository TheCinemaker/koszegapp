                        ...
                        <FadeUp key={item.id} delay={idx * 0.1 + 0.2} className="md:col-span-2">
                          <Link
                            ...
                            className="
                                    ...
                                    bg-gradient-to-br from-[#1c1c1e] to-[#2c2c2e] dark:from-black dark:to-[#1c1c1e]
                          ...
                          >
                            ...
                            <div className="relative z-10 flex flex-col sm:flex-row items-start sm:items-center gap-6">
                              ...
                              <div className="flex-1">
                                ...
                                <p className="text-gray-300 text-sm leading-relaxed max-w-lg mb-6 desc-text">
                                  Ismerd meg a csapatot és a víziót a város digitális újjászületése mögött.
                                </p>
