...
export const STAT_CARDS_CONFIG = [
  ...
  { key: 'FF',         label: 'Szélsebesség',    icon: <Wind className="w-4 h-4 sm:w-5 sm:h-5 text-[#0a97be]" />, unit: 'm/s',color: '#0a97be', fmt: v => v.toFixed(1) },
  { key: 'FXY',        label: 'Széllökés',       icon: <Wind className="w-4 h-4 sm:w-5 sm:h-5 text-[#3385a2]" />, unit: 'm/s',color: '#3385a2', fmt: v => v.toFixed(1) },
