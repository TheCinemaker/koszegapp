...
És összekapcsol minket.`,
  },
  {
    ...
    text: `Nem egy külső multinacionális platform.
...
Hanem egy tudatos döntés a helyi gazdaság mellett.`,
  },
  {
    ...
    text: `A KőszegPass nem csak egy kedvezmény.
...
És most már a kezedben van a kulcs hozzá.`,
  },
  {
    ...
    text: `Hulladéknaptár. Értesítések. Forgalom.
...
És Kőszeg kapui megnyílnak előtted.`,
  },
  {
    ...
    title: "A Múlt, ami Él",
    text: `A történelem nem egy poros könyv.
    ...
    >
      ...
      <section className="h-screen flex flex-col items-center justify-center text-center px-6 relative">
        <motion.h1
          ...
          transition={{ duration: 1.6, ease: [0.22, 1, 0.3, 1] }}
