                ...
                <FadeUp className="relative overflow-hidden rounded-[3rem] bg-zinc-900 text-white p-12 md:p-20 text-center">
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="text-lg text-zinc-400 mb-12 max-w-xl mx-auto">
                            A KőszegApp jegyrendszere nem csak jegyet ad: élményt nyújt. Apple Wallet támogatás, Google Wallet támogatás (hamarosan), QR-kódos PDF-ek és villámgyors mobil szkenner – mindezt extra beruházás nélkül.
                        </p>
