...
return (
  <>
    {/* Háttér overlay, ha drawer nyitva */}
    {open && (
      <div
    ...
    >
      ...
      {/* ← EZ A FÜL sticky‑ként a drawer jobb élén */}
      <div
        className="sticky top-1/2 right-0 translate-x-full -translate-y-1/2 cursor-pointer z-50"
        onClick={() => setOpen(o => !o)}
      >
