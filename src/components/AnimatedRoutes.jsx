...
const SurroundingEvents = lazyWithRetry(() => import('../pages/SurroundingEvents'));
    ...
    <DirectionContext.Provider value={direction}>
      <Suspense fallback={<LoadingSpinner fullScreen={true} label="Betöltés..." />}>
        ...
        <AnimatePresence custom={direction} initial={false}>
          ...
          <Route path="/surrounding-events" element={<PageWrapper morph><SurroundingEvents events={appData.surroundingEvents} loading={appData.loading} /></PageWrapper>} />
          ...
          <Route path="/surrounding-events/:id" element={<PageWrapper><EventDetail /></PageWrapper>} />
